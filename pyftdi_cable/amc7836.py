...
class AMC7836:
    ...
    def set_dac_range(self, range_value: int):
        ...
        if range_value == 5:
            ...
            dac_range_value = 0x55
        elif range_value == -10:
            dac_range_value = 0x44
        else:
    ...
    def set_voltage_positive(self, voltage: float, address: int):
        digital_value = int((voltage * 4095) / 10)
        ...
        self.spi_communication.write_register(address, data)

    def set_voltage_negtagive(self, voltage: float, address):
        digital_value = int(((voltage + 10) * 4095) / 10)
